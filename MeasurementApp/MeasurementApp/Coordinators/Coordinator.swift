...
//  MeasurementApp
//
//  Created by ayush bachuwar on 7/12/23.
//
    ...
    @objc func handleTap(_ recognizer: UITapGestureRecognizer) {
        ...
        if let result = results.first {
            ...
            if startAnchor == nil {
                ...
                let box = ModelEntity(mesh: MeshResource.generateSphere(radius: 0.005), materials: [SimpleMaterial(color: .gray, isMetallic: true)])
